...
namespace DEV_Form
{
    public partial class Fm_Cust : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Cmd.CommandText = "UPDATE TB_CUST_LKK                      " +
                             ...
                             " IF (@@ROWCOUNT =0)                      " +
                             " INSERT INTO TB_CUST_LKK (CUSTCODE,     CUSTTYPE,     CUSTNAME,     BIZCLASS,     BIZTYPE,     USEFLAG,     FIRSTDATE,   MAKEDATE,   MAKER) " +
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                #region Transaction Commit
                Cmd.CommandText = $"DELETE TB_CUST_LKK WHERE CUSTCODE = '{delCustCode}'";
                Cmd.ExecuteNonQuery();
                Txn.Commit();
                #endregion
